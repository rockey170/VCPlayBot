...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot not in this chat, Ask admin to send /play command for first time or add {user.first_name} manually request here @AiGroupManager with your group link</i>"
        )
        return
    text_links=None
